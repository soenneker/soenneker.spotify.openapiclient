...
namespace Soenneker.Spotify.OpenApiClient.Models
{
    ...
    public partial class QueueObjectCurrentlyPlaying : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Spotify.OpenApiClient.Models.QueueObjectCurrentlyPlaying"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Spotify.OpenApiClient.Models.QueueObjectCurrentlyPlaying CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
            var result = new global::Soenneker.Spotify.OpenApiClient.Models.QueueObjectCurrentlyPlaying();

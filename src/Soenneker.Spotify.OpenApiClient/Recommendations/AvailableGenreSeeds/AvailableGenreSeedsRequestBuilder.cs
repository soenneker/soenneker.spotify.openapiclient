...
using System;
namespace Soenneker.Spotify.OpenApiClient.Recommendations.AvailableGenreSeeds
{
    /// <summary>
    /// Builds and executes requests for operations under \recommendations\available-genre-seeds
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class AvailableGenreSeedsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Spotify.OpenApiClient.Recommendations.AvailableGenreSeeds.AvailableGenreSeedsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Spotify.OpenApiClient.Models.ManyGenresResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Spotify.OpenApiClient.Models.ManyGenresResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Spotify.OpenApiClient.Models.ManyGenresResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Spotify.OpenApiClient.Models.ManyGenresResponse>(requestInfo, global::Soenneker.Spotify.OpenApiClient.Models.ManyGenresResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve a list of available genres seed parameter values for [recommendations](/documentation/web-api/reference/get-recommendations).
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Spotify.OpenApiClient.Recommendations.AvailableGenreSeeds.AvailableGenreSeedsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]

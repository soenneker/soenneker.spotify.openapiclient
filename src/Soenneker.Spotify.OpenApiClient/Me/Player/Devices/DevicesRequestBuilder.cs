...
namespace Soenneker.Spotify.OpenApiClient.Me.Player.Devices
{
    ...
    public partial class DevicesRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Spotify.OpenApiClient.Models.ManyDevicesResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Spotify.OpenApiClient.Models.ManyDevicesResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Spotify.OpenApiClient.Models.ManyDevicesResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Spotify.OpenApiClient.Models.ManyDevicesResponse>(requestInfo, global::Soenneker.Spotify.OpenApiClient.Models.ManyDevicesResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get information about a user’s available Spotify Connect devices. Some device models are not supported and will not be listed in the API response.
        /// </summary>

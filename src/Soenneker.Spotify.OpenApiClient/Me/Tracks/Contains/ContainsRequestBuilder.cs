...
using System;
namespace Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<bool?>?> GetAsync(Action<RequestConfiguration<global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder.ContainsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<bool?>> GetAsync(Action<RequestConfiguration<global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder.ContainsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder.ContainsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder.ContainsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Check if one or more tracks is already saved in the current Spotify user&apos;s &apos;Your Music&apos; library.**Note:** This endpoint is deprecated. Use [Check User&apos;s Saved Items](/documentation/web-api/reference/check-library-contains) instead.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ContainsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Spotify.OpenApiClient.Me.Tracks.Contains.ContainsRequestBuilder.ContainsRequestBuilderGetQueryParameters>
        {
        }
    }
}
